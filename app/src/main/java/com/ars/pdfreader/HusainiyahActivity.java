...
public class HusainiyahActivity extends AppCompatActivity {
    WebView wv;
    TextView judulView;
    ImageView backBtn;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_husainiyah);
...
//        judulView.setText(getIntent);
        ...
        wv.loadUrl("file:///android_asset/Husainiyah/index.html");
    }
}